...
<div class='users index'>
	<h2>Monthly Payment of Teacher</h2>
	<table>
		<tr>
			<th>ID</th>
			<th>Student</th>
		...
		<tr>
			...
			<td><?php echo $this->Html->link($teacher['User']['username'],
		...
		<tr><?php
			if($create_payment == true){
				...
				echo $this->Html->Link('Acept and create payment last month', array('action' => 'monthly_payment_student', 'option' => 'create'));
